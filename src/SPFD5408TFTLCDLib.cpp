...
// OR BREAKOUT BOARD USAGE.  SEE RELEVANT COMMENTS IN SPFD5408TFTLCDLib.h
...
SPFD5408TFTLCDLib::SPFD5408TFTLCDLib(
...
SPFD5408TFTLCDLib::SPFD5408TFTLCDLib(void) : Adafruit_GFX(TFTWIDTH, TFTHEIGHT) {
	init();
}

// Initialization common to both shield & breakout configs

void SPFD5408TFTLCDLib::init(void) {
...
void SPFD5408TFTLCDLib::begin(uint16_t id) {
	reset();
	delay(200);
	uint16_t a, d;
	CS_ACTIVE;
...
void SPFD5408TFTLCDLib::reset(void) {
	CS_IDLE;
	WR_IDLE;
	RD_IDLE;
...
void SPFD5408TFTLCDLib::setAddrWindow(int x1, int y1, int x2, int y2) {
	CS_ACTIVE;
	uint32_t t;
	t = x1;
	t <<= 16;
...
void SPFD5408TFTLCDLib::setLR(void) {
	CS_ACTIVE;
...
void SPFD5408TFTLCDLib::flood(uint16_t color, uint32_t len) {
	uint16_t blocks;
...
void SPFD5408TFTLCDLib::drawFastHLine(int16_t x, int16_t y, int16_t length,
		uint16_t color) {
	int16_t x2;
...
void SPFD5408TFTLCDLib::drawFastVLine(int16_t x, int16_t y, int16_t length,
		uint16_t color) {
	int16_t y2;
...
void SPFD5408TFTLCDLib::fillRect(int16_t x1, int16_t y1, int16_t w, int16_t h,
		uint16_t fillcolor) {
	int16_t x2, y2;
...
void SPFD5408TFTLCDLib::fillScreen(uint16_t color) {
...
void SPFD5408TFTLCDLib::drawPixel(int16_t x, int16_t y, uint16_t color) {
	// Clip
...
void SPFD5408TFTLCDLib::pushColors(uint16_t *data, uint8_t len, boolean first) {
	uint16_t color;
	uint8_t hi, lo;
	CS_ACTIVE;
...
void SPFD5408TFTLCDLib::setRotation(uint8_t x) {
...
uint16_t SPFD5408TFTLCDLib::readPixel(int16_t x, int16_t y) {
	return 0;
}

// Ditto with the read/write port directions, as above.

uint16_t SPFD5408TFTLCDLib::readID(void) {
	/* FORCE Identification, as that display returns "0". */
	return 0x9341;
}

uint32_t SPFD5408TFTLCDLib::readReg(uint8_t r) {
	uint32_t id;
	uint8_t x;
...
uint16_t SPFD5408TFTLCDLib::color565(uint8_t r, uint8_t g, uint8_t b) {
...
void SPFD5408TFTLCDLib::write8(uint8_t value) {
	write8inline(value);
}
#endif
...
uint8_t SPFD5408TFTLCDLib::read8fn(void) {
	uint8_t result;
	read8inline(result);
	return result;
}
...
void SPFD5408TFTLCDLib::setWriteDir(void) {
	setWriteDirInline();
}
#endif
...
void SPFD5408TFTLCDLib::setReadDir(void) {
	setReadDirInline();
}
#endif
...
void SPFD5408TFTLCDLib::writeRegister8(uint8_t a, uint8_t d) {
...
void SPFD5408TFTLCDLib::writeRegister16(uint16_t a, uint16_t d) {
...
void SPFD5408TFTLCDLib::writeRegisterPair(uint8_t aH, uint8_t aL, uint16_t d) {
	writeRegisterPairInline(aH, aL, d);
}
#endif

void SPFD5408TFTLCDLib::writeRegister24(uint8_t r, uint32_t d) {
	CS_ACTIVE;
	CD_COMMAND;
	write8(r);
	CD_DATA;
...
void SPFD5408TFTLCDLib::writeRegister32(uint8_t r, uint32_t d) {
	CS_ACTIVE;
	CD_COMMAND;
	write8(r);
	CD_DATA;
